...
## [Unreleased](https://git.d3data.de/D3Private/Multilang/compare/5.1.0.1...rel_5.x)

## [5.1.0.1](https://git.d3data.de/D3Private/Multilang/compare/5.1.0.0...5.1.0.1) - 2026-08-14
### Fixed
- Sonderzeichen im Admin korrekt speichern
### added
- erlaube "null" Wert als SprachID
