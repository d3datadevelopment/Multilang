...
{
    protected $_sThisTemplate = '@' . Constants::OXID_MODULE_ID . '/admin/d3_cfg_multilang_main';
    ...
    public function languageselect(): void
    {
        ...
        if ($this->aLangSel['right'] === false) {
            return;
        }

        if ($this->aLangSel['right'] == '') {
            return;
        }
